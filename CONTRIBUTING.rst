...
1. Fork `the repository <https://github.com/augmentedfabricationlab/xr_assembly>`_ and clone the fork.
...
When `reporting a bug <https://github.com/augmentedfabricationlab/xr_assembly/issues>`_
please include:
...
`Github <https://github.com/augmentedfabricationlab/xr_assembly/issues>`_. If you are proposing a feature:
